...
public class Tweet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Tweet\",\"namespace\":\"com.avro.trial.schema\",\"fields\":[{\"name\":\"tweetId\",\"type\":\"int\"},{\"name\":\"user\",\"type\":\"string\"},{\"name\":\"text\",\"type\":\"string\"}]}");
  ...
  public static com.avro.trial.schema.Tweet.Builder newBuilder() {
    return new com.avro.trial.schema.Tweet.Builder();
  }
  
  /** Creates a new Tweet RecordBuilder by copying an existing Builder */
  public static com.avro.trial.schema.Tweet.Builder newBuilder(com.avro.trial.schema.Tweet.Builder other) {
    return new com.avro.trial.schema.Tweet.Builder(other);
  }
  
  /** Creates a new Tweet RecordBuilder by copying an existing Tweet instance */
  public static com.avro.trial.schema.Tweet.Builder newBuilder(com.avro.trial.schema.Tweet other) {
    return new com.avro.trial.schema.Tweet.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Tweet>
    ...
    private Builder() {
      super(com.avro.trial.schema.Tweet.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.avro.trial.schema.Tweet.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing Tweet instance */
    private Builder(com.avro.trial.schema.Tweet other) {
            super(com.avro.trial.schema.Tweet.SCHEMA$);
    ...
    /** Sets the value of the 'tweetId' field */
    public com.avro.trial.schema.Tweet.Builder setTweetId(int value) {
    ...
    public com.avro.trial.schema.Tweet.Builder clearTweetId() {
    ...
    /** Sets the value of the 'user' field */
    public com.avro.trial.schema.Tweet.Builder setUser(java.lang.CharSequence value) {
    ...
    public com.avro.trial.schema.Tweet.Builder clearUser() {
      user = null;
    ...
    /** Sets the value of the 'text' field */
    public com.avro.trial.schema.Tweet.Builder setText(java.lang.CharSequence value) {
    ...
    public com.avro.trial.schema.Tweet.Builder clearText() {
      text = null;
